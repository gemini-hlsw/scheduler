...
class SchedulerParameters:
    ...
    def from_json(received_params: dict) -> 'SchedulerParameters':
        return SchedulerParameters(Time(received_params['startTime'], format='iso', scale='utc'),
                                   ...
                                   RankerParameters(thesis_factor=received_params['rankerParameters']['thesisFactor'],
                                                    power=received_params['rankerParameters']['power'],
                                                    wha_power=received_params['rankerParameters']['whaPower'],
                                                    met_power=received_params['rankerParameters']['metPower'],
                                                    vis_power=received_params['rankerParameters']['visPower']),
