from common.helpers import dmsstr2deg, hmsstr2deg
...
def get_api_program() -> Program:
    ...
    """
    with open(os.path.join('GN-2022A-Q-999.json'), 'r') as f:
